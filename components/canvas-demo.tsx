            ...
            <ol className="relative h-[13rem] w-full shrink-0">
              {BEATS.map((beat, index) => (
                ...
                >
                  ...
                  {/* Balanced, not pretty. These are two or three centred
                      lines under a heading, where an uneven rag is the thing
                      you notice; `pretty` only tidies the last line and leaves
                      the block lopsided. Long-form copy elsewhere keeps
                      `pretty`, which is what it is for. */}
                  <p className="mx-auto mt-5 max-w-[46ch] text-[16px] leading-[1.6] text-ink-secondary text-balance">
                    {beat.body}
                  </p>
                </li>
              ))}
